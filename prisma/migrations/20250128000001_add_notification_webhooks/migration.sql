...
-- CreateIndex
CREATE INDEX "notification_webhooks_userId_isEnabled_idx" ON "notification_webhooks"("userId", "isEnabled");

-- CreateIndex
CREATE INDEX "notification_webhooks_platform_idx" ON "notification_webhooks"("platform");
